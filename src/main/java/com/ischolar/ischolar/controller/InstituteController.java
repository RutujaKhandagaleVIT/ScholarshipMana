...
public class InstituteController {
	...
	@GetMapping("/{id}/application_action_institute") 
	public String application_action_institute(@PathVariable("id") Integer id, Model model, Principal principal) {
		...
		return "institute/applliaction_action_institute";
	}
	
	@PostMapping("/application_appove_institute") 
	public String applicationActionInstitute(@RequestParam("id") int id, @RequestParam("msg") String msg,@RequestParam("action") String action ,Model model, Principal principal) {
		try {
			boolean edit = false;
			...
			apkDao.updateInstitute(action, id, edit, msg);
		}
		catch(Exception e) {
			e.printStackTrace();	
